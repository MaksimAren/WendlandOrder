...
std::string folder = "/Users/maksim/Desktop/Xcode/Institute_programs/WendlandOrder";
...
//    const double gamma = 7;
    ...
    const int N_gas_particles_per_unit_side = 67;
    const double h = 0.8;
...
int main(int argc, const char * argv[]) {
    ...
    for (int n = 1; n <= N_time; n++) {
        ...
        std::cout << "Шаг " << n << " из " << N_time << std::endl;
    }
    ...
    std::cout << "Конечная максимальная погрешность скорости = " << max_error_v << std::endl;
    std::cout << "Начальная максимальная погрешность плотности = " << init_max_error_rho << std::endl;
    std::cout << "Конечная максимальная погрешность плотности = " << max_error_rho << std::endl;
    ...
    if (out_1D.is_open()) {
        ...
        out_1D << "# 1) X 2) u 3) rho 4) an_u 5) an_rho" << std::endl;
        out_1D << "# " << std::endl;
        for (auto &pi : particles) {
...
void density_based_arrangement(std::vector<particle> &particles, initial_data &InitData) {
    ...
    double curr_b;
    double curr_I;
    std::cout << "граница [" << 0 << "] из [" << N << "] готова" << std::endl;
    for (int i = 1; i < N; i++) {
        curr_b = borders[i - 1];
        curr_I = 0;
        do {
        ...
        borders[i] = curr_b;
        std::cout << "граница [" << i << "] из [" << N << "] готова" << std::endl;
    }
    std::cout << "граница [" << N << "] из [" << N << "] готова" << std::endl;
    for (int i = 0; i < N; i++) {
